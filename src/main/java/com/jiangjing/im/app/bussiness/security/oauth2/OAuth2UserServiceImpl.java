...
import com.jiangjing.im.app.bussiness.utils.ThirdUserConverter;
...
public class OAuth2UserServiceImpl extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if ("gitee".equals(registrationId)) {
            convert = ThirdUserConverter.giteeConvert(userRequest, oAuth2User);
        } else if ("github".equals(registrationId)) {
            convert = ThirdUserConverter.githubConvert(userRequest, oAuth2User);
        } else {
            return null;
        }
